...
/******/ 	var hotCurrentHash = "8ecb2737bfa2235657ec"; // eslint-disable-line no-unused-vars
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        updateTotal: function updateTotal() {
	            ...
	            _resources.BillResource.total().then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bill = __webpack_require__(37);
	    ...
	    methods: {
	        submit: function submit() {
	            ...
	            if (this.formType == 'insert') {
	                ...
	                _resources.BillResource.update({ id: this.bill.id }, data).then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (true) {(function () {  module.hot.accept()
	  var hotAPI = __webpack_require__(42)
	  hotAPI.install(__webpack_require__(28), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-690a7ff8/Bill.vue"
	  if (!module.hot.data) {
